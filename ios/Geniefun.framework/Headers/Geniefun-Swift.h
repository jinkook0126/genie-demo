...
@interface GeniefunView : NSObject <APSSPInterstitialAdDelegate, APSSPInterstitialVideoAdDelegate, APSSPRewardVideoAdDelegate, WKNavigationDelegate, WKUIDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
